...
public abstract class Dao<T> {
	...
	/**
	 * @param primaryKey
	 *            clé primaire de l'enregistrement en base que l'on veut lire
	...
	/**
	 * @param object
	 *            enregistrement en base que l'on souhaite modifier
	...
	/**
	 * @param object
	 *            enregistrement en base que l'on souhaite supprimer
	 */
